...
<!-- Mirrored from preview.colorlib.com/theme/Tavelanka/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Feb 2025 14:44:51 GMT -->
<head>
    <title>Tavelanka - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
    		...
    		<div class="row d-flex">
    			...
    			<div class="col-md-6 pl-md-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            <h2 class="mb-4">About Tavelanka</h2>
		            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
		          </div>
		        </div>
		    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
	    				...
	    				<div class="text">
	    					...
	    					<h3><a href="project.php">New Orleans Hotel</a></h3>
	    					<div class="star d-flex clearfix">
	    						<div class="mr-auto float-left">
		    						<span class="ion-ios-star"></span>
		    						<span class="ion-ios-star"></span>
    			...
    			<div class="col-md-6 col-lg-4 ftco-animate">
    				<div class="project">
	    				...
	    				<div class="text">
	    					<h4 class="price">$600</h4>
	    					<span>300 per person</span>
	    					<h3><a href="project.php">New Orleans Restaurant</a></h3>
	    					<div class="star d-flex clearfix">
	    						<div class="mr-auto float-left">
		    						<span class="ion-ios-star"></span>
		    						<span class="ion-ios-star"></span>
